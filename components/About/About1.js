      ...
      >
        ...
        >
          <span className="about-1 leading-tight">
            Je suis un passionné d&apos;informatique spécialisé dans l&apos;administration système et réseau.{" "}
          </span>
          <span className="about-2 leading-tight">
            J&apos;assure la fiabilité, la sécurité et la performance des infrastructures informatiques.{" "}
          </span>
        </h2>
      </div>
    </section>
